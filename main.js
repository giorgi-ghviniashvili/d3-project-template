...
module.exports = JSON.parse("[{\"x\":20,\"y\":30,\"r\":10},{\"x\":80,\"y\":20,\"r\":15}]");

/***/ }),

/***/ "./src/scripts/charts/Chart.js":
/*!*************************************!*\
  !*** ./src/scripts/charts/Chart.js ***!
  \*************************************/
/*! exports provided: default */
...
var Chart = /*#__PURE__*/function () {
  function Chart(props) {
    ...
    var params = Object.assign({
      ...
      width: 0,
      // calculated dynamically if zero 
      height: 450,
      margin: {
        top: 15,
        right: 15,
    ...
    this.params = params;
    this.container = Object(d3_selection__WEBPACK_IMPORTED_MODULE_0__["select"])(params.container || 'body');
  ...
  _createClass(Chart, [{
    ...
    value: function renderContainers() {
      ...
      this.chart = this.svg.append('g').attr('class', 'chart').attr('transform', "translate(".concat(margin.left, ", ").concat(margin.top, ")"));
    }
  }, {
    key: "draw",
    value: function draw() {
      ...
      if (this.params.data) {
        this.chart.selectAll('circle').data(this.params.data).join(function (enter) {
          return enter.append('circle').attr('cx', function (d) {
            return d.x;
          }).attr('cy', function (d) {
            return d.y;
          }).attr('r', 0).transition().duration(_this.params.transitionTime).attr('r', function (d) {
            return d.y;
          }).attr('fill', 'navy');
        }, function (update) {
          return update;
...
/* harmony import */ var _charts_Chart__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./charts/Chart */ "./src/scripts/charts/Chart.js");
...
var App = function App(data) {
  ...
  this.chart = new _charts_Chart__WEBPACK_IMPORTED_MODULE_1__["default"]({
    container: '#chart',
    data: data
  });
  this.chart.render();
...
new App(_data_data_json__WEBPACK_IMPORTED_MODULE_2__);
